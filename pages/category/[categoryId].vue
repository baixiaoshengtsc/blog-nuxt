 ...
 * @LastEditTime: 2024-02-05 00:03:55
...
const queryArticleList = async () => {
    scrollTop()
    let { data, refresh } = await article.queryArticleListByCategory({ current: current.value, size: size.value, categoryId: Number(route.params.categoryId) })
